...
public class Escola extends Construcao {
    ...
    public Escola(String nomeEscola, int numPessoas, int numLampadas, boolean isEnergiaRenovavel, boolean isArCondicionado) {
    ...
    public void getCarbonFootprint() {
       System.out.println("Emissão de carbono anual da escola: ");
